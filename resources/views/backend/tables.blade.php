    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2"
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand px-4 py-3 m-0"
                ...
                <img src="{{ 'backend/assets/img/logo-ct-dark.png' }}" class="navbar-brand-img" width="26"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="{{ 'backend/assets/img/team-3.jpg' }}"
                                                            class="avatar avatar-sm me-3 border-radius-lg"
                                                            alt="user2">
                                                    </div>
                                                    <div class="d-flex flex-column justify-content-center">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="{{ 'backend/assets/img/team-4.jpg' }}"
                                                            class="avatar avatar-sm me-3 border-radius-lg"
                                                            alt="user3">
                                                    </div>
                                                    <div class="d-flex flex-column justify-content-center">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2">
                                                    <div>
                                                        <img src="{{ 'backend/assets/img/small-logos/logo-asana.svg' }}"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2">
                                                    <div>
                                                        <img src="{{ 'backend/assets/img/small-logos/github.svg' }}"
                                                            class="avatar avatar-sm rounded-circle me-2"
                                                            alt="invision">
                                                    </div>
                                                    <div class="my-auto">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2">
                                                    <div>
                                                        <img src="{{ 'backend/assets/img/small-logos/bootstrap.svg' }}"
                                                            class="avatar avatar-sm rounded-circle me-2"
                                                            alt="webdev">
                                                    </div>
                                                    <div class="my-auto">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2">
                                                    <div>
                                                        <img src="{{ 'backend/assets/img/small-logos/devto.svg' }}"
                                                            class="avatar avatar-sm rounded-circle me-2"
                                                            alt="xd">
                                                    </div>
                                                    <div class="my-auto">
